...
public class ChannelWhitelistAttemptEvent extends Event {
    private static final HandlerList handlers = new HandlerList();
    private String receivedNickname;
    private Member guildMember;
    private Channel receivedChannel;

    public ChannelWhitelistAttemptEvent(Member guildMember, String receivedNickname, Channel receivedChannel) {
